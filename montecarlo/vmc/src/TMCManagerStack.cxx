...
TMCManagerStack::TMCManagerStack()
  : TVirtualMCStack(), fCurrentTrackId(-1), fUserStack(nullptr),
    fTotalNPrimaries(nullptr), fTotalNTracks(nullptr),
    fParticles(nullptr), fParticlesStatus(nullptr),
    fBranchArrayContainer(nullptr)
{
}
...
void TMCManagerStack::PushTrack(Int_t toBeDone, Int_t parent, Int_t pdg,
                                ...
                                Double_t weight, Int_t is)
{
  ...
  fUserStack->PushTrack(toBeDone, parent, pdg, px, py, pz,e, vx, vy, vz, tof,

...
TVirtualMC::TVirtualMC(const char *name, const char *title, Bool_t /*isRootGeometrySupported*/)
   : TNamed(name, title), fApplication(0), fId(0), fStack(0), fManagerStack(0), fDecayer(0), fRandom(0), fMagField(0),
     fUseExternalGeometryConstruction(kFALSE), fUseExternalParticleGeneration(kFALSE)
{
...
TVirtualMC::TVirtualMC()
   : TNamed(), fApplication(0), fId(0), fStack(0), fManagerStack(0), fDecayer(0), fRandom(0), fMagField(0),
     fUseExternalGeometryConstruction(kFALSE), fUseExternalParticleGeneration(kFALSE)
{
}
...
void TVirtualMC::TrackPosition(Double_t &x, Double_t &y, Double_t &z, Double_t &t) const
{
   t = TrackTime();
   TrackPosition(x, y, z);
}
...
void TVirtualMC::TrackPosition(Float_t &x, Float_t &y, Float_t &z, Float_t &t) const
{

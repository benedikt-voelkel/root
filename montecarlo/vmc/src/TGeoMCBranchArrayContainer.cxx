...
TGeoMCBranchArrayContainer::TGeoMCBranchArrayContainer()
   : fCacheSize(0), fInitCacheSize(0), fNextIndex(0), fCurrentIndex(-1), fMaxLevels(0), fIsInitialized(kFALSE)
{
}
...
const TGeoBranchArray *TGeoMCBranchArrayContainer::GetGeoState(UInt_t id)
{
   if (id >= fCacheSize) {
